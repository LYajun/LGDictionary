...
typedef NS_ENUM(NSInteger,LGDicMeanType){
    LGDicMeanTypeSenCollection,
    LGDicMeanTypeColtCollection,
    LGDicMeanTypeClassicCollection,
    LGDicMeanTypeRltCollection,
    LGDicMeanTypeEnglishCollection
};
