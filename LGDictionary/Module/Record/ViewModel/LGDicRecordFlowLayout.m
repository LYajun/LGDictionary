...
@interface LGDicRecordFlowLayout ()
...
@end
@implementation LGDicRecordFlowLayout
    ...
    for (NSInteger section = 0; section < [self.collectionView numberOfSections]; section++) {
        for (NSInteger item = 0; item < [self.collectionView numberOfItemsInSection:section]; item++) {
            ...
            if (indexPath.item == 0) {
                ...
                titleAttributes.frame = CGRectMake(0, originY, LGDictionaryScreenW, height);
